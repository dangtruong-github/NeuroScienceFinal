...
def process_td_channel(data_path, train_meta_df, test_meta_df):
...
if __name__ == "__main__":
    data_path = "../data/csv/td_channel_fill.csv"
    ...
    X_train, y_train, X_test, y_test = process_td_channel(data_path, train_meta_df, test_meta_df)
